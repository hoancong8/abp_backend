...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c8f43c39-c31b-4fe7-ac28-8fa1913d2e58
```

> `c8f43c39-c31b-4fe7-ac28-8fa1913d2e58` is the password of the certificate, you can change it to any password you want.
